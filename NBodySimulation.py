...
def main():
	...
	position  = np.random.randn(N, 3)   # randomly selected positions and velocities
	...
	acceleration = Acceleration(position, mass, G, softening )
	...
	for i in range(Nt):
		...
		if plotRealTime or (i == Nt-1):
			...
			plt.scatter(position[:, 0], position[:, 1], s = 10, color='blue')
